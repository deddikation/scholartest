...
<html>
    <head>
        ...
        <title>About Content Edit</title>
    </head>
    <body>
 ...
 <div class="topnav">
              <ul>
                  ...
                  <li  class="dropdown"> <a class="active" href="javascript:void(0)" class="dropbtn">App Content</a>
                    ...
                    <div class="dropdown-content">
                        <a class="active" href="editabout.php">About The App</a>
  ...
  <br><br><br>
        ...
        <form  method = "post">
             <tr>
               <td>About the App Content:</td><br>
             <td><textarea name="desc" rows="4" cols="100">Type "About The App" Content..</textarea>
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST") 
      {
            ...
            $q = "UPDATE `about` SET `description`='".$desc."' where id=1";
            mysqli_query($conn,$q);
