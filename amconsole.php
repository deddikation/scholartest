...
<html>
    ...
    <body   >
     ...
     <div id="popular-req" class="popular-req"style="border: #073D85;border-style: inset;">
         ...
         <div class="row">
             <img src="images/req.png">  <a href="registerAssociation.php">Register Association</a><br>
             <img src="images/req.png"><a href="editAssociation.php">Edit Association Details</a><br>
             <img src="images/req.png"> <a href="reset.php">Reset Association Login Password</a><br>
